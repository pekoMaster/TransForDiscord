...
| `handlers/twitter-v2-interactions.js` | Twitter V2 translate/original, expand/collapse, reload, spoiler modal flow. | interaction-handler | twitter | `src/features/twitter/interactions/v2-router.js` | split | Translate/toggle/reload/spoiler modules are split; render-state fallback/merge lives in `src/features/twitter/interactions/v2/render-state.js`; continue separating edit/render concerns incrementally. |
