...
| `src/features/sites/facebook/strategies/mbasic.js` | Canonical Facebook mbasic fallback extractor. | extractor | sites/facebook | `src/features/sites/facebook/strategies/mbasic.js` | keep | Strategy implementation. |
| `src/features/sites/facebook/strategies/with-login.js` | Canonical Facebook logged-in browser extractor. | extractor | sites/facebook | `src/features/sites/facebook/strategies/with-login.js` | keep | Strategy implementation. |
| `src/features/sites/facebook/strategies/facebookez.js` | Canonical FacebookEZ/fx style extractor. | extractor | sites/facebook | `src/features/sites/facebook/strategies/facebookez.js` | keep | Strategy implementation. |
| `tfd-system/extractors/facebook-mbasic.js` | Legacy adapter for Facebook mbasic fallback extractor. | adapter | sites/facebook | `src/features/sites/facebook/strategies/mbasic.js` | done-adapter | Preserves facebook-smart import path. |
| `tfd-system/extractors/facebook-with-login.js` | Legacy adapter for Facebook logged-in browser extractor. | adapter | sites/facebook | `src/features/sites/facebook/strategies/with-login.js` | done-adapter | Preserves facebook-smart import path. |
| `tfd-system/extractors/facebookez.js` | Legacy adapter for FacebookEZ/fx style extractor. | adapter | sites/facebook | `src/features/sites/facebook/strategies/facebookez.js` | done-adapter | Preserves extractor registry import path. |
