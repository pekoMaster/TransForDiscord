...
>
> No message text, no usernames, no message history is ever stored. Full privacy policy: [link to ../legal/privacy-policy.md]
...
- **隱私政策**：https://github.com/pekoMaster/TransForDiscord/blob/master/docs/legal/privacy-policy.md
- **服務條款**：https://github.com/pekoMaster/TransForDiscord/blob/master/docs/legal/terms-of-service.md
